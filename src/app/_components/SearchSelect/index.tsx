...
const EditablePickList: React.FC<SearchSelectProps> = ({
  ...
  return (
    <div className="relative flex flex-col">
      ...
      <div
        className={cn(
          "flex w-fit min-w-[250px] items-center justify-between rounded-b-xl rounded-t-xl bg-slate-100 px-2 py-1 ring-slate-400 focus:ring-2",
      ...
      {showList && filteredItems.length ? (
        <div className="max-h-30 absolute top-full z-50 flex w-full max-w-[250px] flex-col overflow-y-auto rounded-b-xl bg-slate-100 px-1.5 py-4">
